...
In artcommision-labels_en.properties:
artcommision=My application
artcommision[description]=My application does this and that

In artcommision-messages_en.properties:
